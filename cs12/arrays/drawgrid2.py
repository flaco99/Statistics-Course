...
# A module built on Pygame to facilitate interactive grid-based drawings.
# Designed to be particularly useful for cellular automata.

# Usage:
# Create a Grid object by passing the constructor a rectangular array (list of lists) of colours.
# Start the drawing by calling the start method, passsing it a 0-argument step function
# which will be called once per frame and should update the original array.
#
# You can add interactivity with onkey and onclick methods.
...
class Grid:
    ...
    def set_update_while_draw(self, update_while_draw):
        """Determines whether the drawing will update while the mouse
           button is held down."""
        self.update_while_draw = update_while_draw
